            ...
            <div class="modal-content">
                <form wire:submit.prevent="storeData">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="CarModalLabel">Tambah Nama Mobil</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Nama </label>
                            <input type="text" placeholder="contoh: Toyota Avanza" class="form-control" id="name1" wire:model="name">
                        </div>
